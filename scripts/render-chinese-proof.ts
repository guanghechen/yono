...
const after = fileURLToPath(new URL(`build/${design.postScriptName}.ttf`, root))
...
drawText(ui, 21, 58, 106, '同字号、同基线、同字距；上行为 0.100，下行为本次修改。', '#66747b')
...
drawText(ui, 20, 58, 1650, '修改：补、沿、缩、容、算。其余字形沿用 0.100；本次未增加字符覆盖。', '#66747b')
